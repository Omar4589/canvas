...
**Reading the numbers up top.** The strip above the map counts different things on purpose. **Books** and **Houses** are the size of the round. **Canvassers** is how many *people* hold at least one book, with the books nobody holds beside it ("83 books unassigned"). The *Assigned* pill to the right counts **books**, not people — so on a 97-book round where 8 people are carrying 14 books, the header reads 8, the pill reads 14, and neither is wrong. The **Crew load** pill at the bottom of the map puts it in one sentence: "8 canvassers · 14 books" — what your crew is actually carrying, not the size of the pass. Open it for each person's own books and doors.
