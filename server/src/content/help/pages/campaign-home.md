...
After the first pass is activated and knocks start coming in, Home becomes a **monitoring dashboard**: households, houses knocked, knocks, surveys, connection rate, active canvassers, and a coverage bar — filterable by date range and by walk list.
