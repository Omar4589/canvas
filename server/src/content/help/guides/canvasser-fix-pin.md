---
slug: canvasser-fix-pin
title: Fixing a pin location
audience: canvasser
kind: guide
order: 32
sourceDoc: MAPS.md
summary: Drag a mis-placed house pin to the right spot — it changes only the dot.
tags: canvasser, pin, map, location, gps
---
...
> Tip: If a pin was so far off that it looked like it belonged to a different area, fixing the pin is still the right move — it just repositions the marker.
