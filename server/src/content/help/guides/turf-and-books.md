...
Cuts only include knockable doors. Already-voted homes are skipped, and you can leave out apartments and [restricted-access homes](restricted-vs-refused) too. Doors you leave out aren't deleted — they stay visible and counted on the [Map](page-map), where you can dim or hide them; they're simply never cut into a book, sent to a phone, or printed. One caution: "leave out apartments" works by spotting many doors on one map spot — and some voter files stamp a placeholder spot on addresses they couldn't place, which looks identical. If the [import preview](voter-imports) warned about doors sharing a spot with other streets, get those pins repaired before cutting, or real houses get held out as "apartments".
