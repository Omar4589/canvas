...
Voter records are often incomplete, so anything the file doesn't have is simply left out. If there's no birthday on record you'll just see "Democratic · Female", and a voter with nothing on file shows only their name. That's normal — nothing is broken.
