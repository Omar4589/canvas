...
> Heads up: A saved search only includes doors that have map coordinates. If your file had no lat/long, those addresses are geocoded on import, and any that can't be placed are left out (and reported).
