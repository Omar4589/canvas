...
- (add questions here)
- ~~"I created a campaign from the Campaigns page and something like 'not created' flashed before the setup steps showed up."~~ → DONE 2026-09-03: it was *"Campaign not found"*, and it was a display bug — the drill-in asked a campaign list written before the campaign existed. Triaged into faq/campaign-not-found-after-creating.md + a line at the top of pages/campaign-home.md. The FAQ keeps its lasting half: what a *persistent* "Campaign not found" actually means (deleted / other org / not a lead's campaign / bad link).
