...
- "Can I add a survey answer after the fact? A canvasser hit Not home but they actually did the survey." → yes, an org admin can, on the Door Outcomes page: select the entries, change them to **Surveyed**, and enter the answers (one set for the batch, or door by door). Credited to the canvasser who knocked, stamped "Entered by ‹admin›". Covered in pages/page-door-outcomes.md + guides/campaigns-manage.md — candidate FAQ, likely "Recording a survey a canvasser forgot to save"
...
- "A canvasser faked a bunch of surveys — how do I get those doors back into play?" → Door Outcomes, select the surveyed entries, change them to **Not home**. You're shown by name whose answers go, the answers are archived (restorable) not destroyed, and only that canvasser's answers are touched. pages/page-door-outcomes.md
...
- "Why does removing answers affect more people than matched my filter?" → because a Surveyed entry is the whole visit: changing it takes every answer that canvasser recorded at that door that round, and the review step names each person and marks who matched vs. who is just at the same visit. pages/page-door-outcomes.md — candidate FAQ; pairs with the faked-surveys question above
