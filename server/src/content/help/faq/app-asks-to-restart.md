---
slug: app-asks-to-restart
title: The app says a new version is ready and asks to restart — do I lose anything?
audience: all
kind: faq
order: 44
...
Doorline improves itself quietly: the app downloads small updates in the background, no app store
involved. When one is ready, a banner appears at the top: **"A new version of Doorline is ready."**
...
This is different from [the app saying an update is available or required](app-says-update-available) —
that one is about installing a new version from the **App Store** or **Google Play**, which takes
about a minute. This restart takes seconds.
