...
export async function archiveOverwrittenResponse(doc, { byUserId, via = 'submit', conversionRunId = null }) {
...
export async function archiveOverwrittenResponses(docs, { byUserId, via, conversionRunId = null }) {
