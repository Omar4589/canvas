// CANONICAL survey-visibility evaluator (Phase 2 conditional logic).
// Mirrored BYTE-FOR-BYTE (everything below the marker) into:
//   client/src/lib/surveyVisibility.js
//   mobile/lib/surveyVisibility.js
// Edit here, then copy the body to both mirrors. A drift-guard test enforces it.
// Contract + fixtures: server/src/services/surveys/__fixtures__/visibility.fixtures.json
// ==== BEGIN MIRRORED BODY ====
