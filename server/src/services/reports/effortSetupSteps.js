...
// when its pass is activated. Mirrors deriveSetupSteps (done/current/todo; first
...
const STEP_DEFS = [
  ...
  { key: 'round', label: 'Pass created', route: '/efforts', satisfied: (c) => (c.passes || 0) >= 1 },
  ...
  { key: 'active', label: 'Pass activated', route: '/efforts', satisfied: (c) => Boolean(c.hasActivePass) },
];
