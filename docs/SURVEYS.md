...
- **The answer's wording comes first, on its own line**, with the percentage and the count lined up
  on the right. A long option — "Supporting law enforcement and first responders" — wraps onto a
  second line rather than being cut off mid-word. The percentages line up in a column down the card,
  so you can compare them by eye without reading each number.
- **The bar sits underneath**, running the full width of the card. Its length is the percentage
  printed beside it, nothing else — a bar and its number never disagree. An answer only one or two
  people gave still paints a visible sliver; an answer nobody gave paints nothing at all.
...
collapsing the sidebar genuinely gives the cards that room. A question with a lot of answers takes a
row to itself rather than leaving a tall blank space beside a short question.
...
very long on a question with a lot of options. The **(i)** next to the card's heading says which of
