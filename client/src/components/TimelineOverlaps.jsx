...
// of the day's colliding doors. This is the first WEB overlaps surface (mobile already had one).
export default function TimelineOverlaps({ data }) {
    ...
    <Card className="p-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        {overlaps.length > 0 && (
          ...
          >
            {open ? 'Hide' : `Review ${overlaps.length} overlap door${overlaps.length === 1 ? '' : 's'}`}
          </button>
        )}
      </div>
