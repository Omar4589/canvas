...
// breakdowns on client reports). items: [{ label, count, percent, color? }]. Bars scale to
// the largest count; percent is shown as given (server-computed for surveys, derived for
// contact outcomes). Pass `emphasis` to make it the headline (support) card.
            ...
            <div key={i.label}>
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="tabular-nums font-semibold text-fg">
                  ...
                  <span className="ml-1 font-normal text-fg-subtle">({i.percent ?? 0}%)</span>
                </span>
              </div>
