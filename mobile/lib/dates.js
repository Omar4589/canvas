// Shared date-display helpers (client/src/lib/dates.js is the byte-parallel source — keep in sync).
//
...
// the admin user profile keeps its 7-day cutoff via { cutoffDays: 7 } — while the accidents (no
// NaN guard, '730d ago' forever) are fixed everywhere.
