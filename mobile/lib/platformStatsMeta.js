// ⓘ copy for the Control Room's numbers, shared web/mobile (client/src/lib/platformStatsMeta.js
// is the byte-parallel source — keep them in sync) so the two apps can never explain a
...
export const OVERVIEW_HELP = {
  ...
  today:
    'Door actions since midnight UTC (not your local midnight), on active campaigns across all orgs: not-home, wrong address, refused, no soliciting, surveys, lit drops. Includes admin bulk marks; “restricted” doors are tallied separately, never as knocks.',
  campaigns:
